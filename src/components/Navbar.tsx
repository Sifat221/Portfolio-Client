...
import { Menu, X, User, Sun, Moon, Shield, ShieldCheck, LogOut, LayoutDashboard } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({ personal, onRefreshData }) => {
      ...
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex items-center justify-between">
            ...
            {/* Right Action Buttons & Admin Dashboard / Theme Toggle */}
              ...
              {isAdminAuth ? (
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3.5 py-2 rounded-full font-mono text-xs font-bold text-emerald-400 bg-emerald-500/10 border border-emerald-500/40 hover:bg-emerald-500/20 transition-all flex items-center gap-1.5 shadow-md active:scale-95"
                  ...
                  <button
                    ...
                    className="p-2 rounded-full text-rose-400 bg-rose-500/10 border border-rose-500/30 hover:bg-rose-500/20 transition-all active:scale-95"
                    title="Logout Admin"
                  >
                ...
                <button
                  ...
                  className="p-2.5 rounded-full glass-card border border-slate-700/60 text-slate-400 hover:text-[#9B8FCD] hover:border-[#9B8FCD] transition-all shadow-md active:scale-95 flex items-center justify-center"
                  title="Admin Sign In"
                >
