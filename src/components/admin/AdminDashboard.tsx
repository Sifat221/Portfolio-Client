      ...
      case 'projects':
        return {
          ...
          fields: [
            ...
            { key: 'githubUrl', label: 'GitHub / Link 1 URL (e.g. GitHub, Figma Prototype, Case Study)', type: 'text' as const },
            { key: 'githubLabel', label: 'Link 1 Button Label (e.g. Case Study, Code, Figma)', type: 'text' as const },
            { key: 'demoUrl', label: 'Live Demo / Link 2 URL', type: 'text' as const },
            { key: 'demoLabel', label: 'Link 2 Button Label (e.g. View Analysis, Live Demo)', type: 'text' as const },
